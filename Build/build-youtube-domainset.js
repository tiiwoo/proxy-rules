...
(async () => {
  console.time('Total Time - build-youtube-domainset-conf');
    ...
    compareAndWriteFile(
      withBannerArray(
        ...
        [
          ...
          '',
          'This file contains Youtube rules.',
          '',
          'Data from:',
      ...
      path.resolve(__dirname, '../List/domainset/youtube.conf')
    ),
    compareAndWriteFile(
      withBannerArray(
        'Surge Rules - Stream',
      ...
      path.resolve(__dirname, '../List/domainset/youtube_fix.conf')
    ),
  ]);

  console.timeEnd('Total Time - build-youtube-domainset-conf');
})();
