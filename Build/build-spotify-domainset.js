...
(async () => {
  console.time('Total Time - build-spotify-domainset-conf');
    ...
    compareAndWriteFile(
      withBannerArray(
        ...
        [
          ...
          '',
          'This file contains Spotify rules.',
          '',
          'Data from:',
      ...
      path.resolve(__dirname, '../List/domainset/spotify.conf')
    ),
    compareAndWriteFile(
      withBannerArray(
        'Surge Rules - Stream',
      ...
      path.resolve(__dirname, '../List/domainset/spotify_fix.conf')
    ),
  ]);

  console.timeEnd('Total Time - build-spotify-domainset-conf');
})();
