...
(async () => {
  console.time('Total Time - build-openai-domainset-conf');
    ...
    compareAndWriteFile(
      withBannerArray(
        ...
        [
          ...
          '',
          'This file contains OpenAI rules.',
          '',
          'Data from:',
      ...
      path.resolve(__dirname, '../List/domainset/openai.conf')
    ),
    compareAndWriteFile(
      withBannerArray(
        'Surge Rules - Stream',
      ...
      path.resolve(__dirname, '../List/domainset/openai_fix.conf')
    ),
  ]);

  console.timeEnd('Total Time - build-openai-domainset-conf');
})();
